...
interface PatientInfoPanelProps {
  ...
  onUpdatePatientInfo: (field: keyof PatientInfo, value: string) => void;
}
    ...
    <div class="bg-blue-50 p-4 rounded-lg mb-6 border border-blue-200 shadow-sm">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        ...
        <div>
          ...
          <input id="patient-dob" type="date" value={props.patientInfo().dob} onInput={e => props.onUpdatePatientInfo('dob', e.currentTarget.value)} class="mt-1 w-full border-gray-300 rounded shadow-sm p-1.5 text-sm focus:border-blue-500 focus:ring-blue-500" />
        </div>
        <div>
