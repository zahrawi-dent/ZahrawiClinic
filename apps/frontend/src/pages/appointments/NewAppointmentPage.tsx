...
const NewAppointmentPage: Component = () => {
  ...
  return (
    <div class="min-h-screen bg-gray-50 p-6 space-y-6">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl md:text-3xl font-bold text-gray-900">New Appointment</h1>
          <p class="text-gray-600">Create and schedule a new appointment</p>
        </div>
      </div>
      ...
      <form
        ...
        class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 grid grid-cols-1 md:grid-cols-2 gap-4"
      >
        <div>
